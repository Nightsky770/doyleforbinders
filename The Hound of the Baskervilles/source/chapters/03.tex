...
<I could not call you in, Mr~Holmes, without disclosing these facts to the world, and I have already given my reasons for not wishing to do so. Besides, besides\longdash>
...
\begin{letter}
	\begin{figure}[tbh]
		\centering
		\includegraphics[width=.9\textwidth]{03_shirtcuff}
...
\begin{a4}
	\begin{figure}[tbh]
		\centering
		\includegraphics[width=.8\textwidth]{03_shirtcuff}
		\caption{He scribbled the appointment on his shirtcuff}
	\end{figure}
\end{a4}
