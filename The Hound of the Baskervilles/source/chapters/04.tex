...
%I Can't Believe It's Not \wrapfig!

\begin{letter}
	
\begin{tikzpicture}[remember picture, overlay]  

\node[anchor=center] (pix) at ($(current page.west)+(4.75cm,3.75cm)$) {\includegraphics[width=.6\textwidth]{04_inch}};
\node[text width=0.5\textwidth,align=center,below=0.3cm of pix,anchor=center] (caption) {\textsc{An inch from his eyes}};
...
\begin{adjustbox}{minipage=0.4\textwidth, right}
...
`If you examine it carefully you will see that both the pen and the ink have given the writer trouble. The pen has spluttered twice in a single word, and has run dry three times in a short address, showing that there was very little ink in the bottle. Now, a 
\end{adjustbox}
...
\node[anchor=center] (pix) at ($(current page.east)+(-5cm,3.5cm)$) {\includegraphics[width=.5\textwidth]{04_inch}};
\node[text width=0.4\textwidth,align=center,below=0.3cm of pix,anchor=center] (caption) {\textsc{An inch from his eyes}};
...
\begin{adjustbox}{minipage=0.4\textwidth, left}
