...
\node (pix) at ($(current page.west)+(4.5cm,4cm)$) {\includegraphics[width=.6\textwidth]{04_inch}};
\node[text width=0.4\textwidth,align=justify,below=-0.1cm of pix] (caption) {\textsc{Holding it an inch from his eyes}};
