...
%Behold the wish.com \wrapfig. Then look away in horror.
...
\node[anchor=center] (pix) at ($(current page.west)+(3.75cm,0.5cm)$) {\includegraphics[width=.5\textwidth]{01_convexlens}};
\node[text width=0.4\textwidth,align=justify,below=0cm of pix,anchor=center] (caption) {\textsc{With a convex lens}};
...
\node[text width=0.3\textwidth,align=justify,below=0cm of pix,anchor=center] (caption) {\textsc{With a convex lens}};
