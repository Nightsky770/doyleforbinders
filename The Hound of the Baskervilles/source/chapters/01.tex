...
\lettrine{M}{r} Sherlock Holmes, who was usually very late in the mornings, save upon those not infrequent occasions when he was up all night, was seated at the breakfast table. I stood upon the hearth-rug and picked up the stick which our visitor had left behind him the night before. It was a fine, thick piece of wood, bulbous-headed, of the sort which is known as a <Penang lawyer>. Just under the head was a broad silver band nearly an inch across. <To James Mortimer, \textsc{m.r.c.s.}, from his friends of the \textsc{c.c.h.}>, was engraved upon it, with the date <1884>. It was just such a stick as the old-fashioned family practitioner used to carry—dignified, solid, and reassuring.
...
%Behold the wish.com \wrapfig. Then look away in horror. (Basically it's a narrow little minipage and a narrow little tikz picture right next to each other.)
...
\begin{letter}
	...
	\begin{tikzpicture}[remember picture, overlay]  
		\node[anchor=center] (pix) at ($(current page.west)+(4cm,1cm)$) {\includegraphics[width=.5\textwidth]{01_convexlens}};
		\node[text width=0.4\textwidth,align=center,below=0cm of pix,anchor=center] (caption) {\textsc{With a convex lens}};
	\end{tikzpicture}
	...
	\begin{adjustbox}{minipage=0.5\textwidth, right}
	...
	<And then again, there is the <friends of the \textsc{c.c.h.}> I should guess that to be the Something Hunt, the local hunt to whose members he has possibly given some surgical assistance, and which has made him a small presentation in return.>
...
\begin{a4}
	...
	\node[anchor=center] (pix) at ($(current page.west)+(4.2cm,0.5cm)$) {\includegraphics[width=.45\textwidth]{01_convexlens}};
	\node[text width=0.5\textwidth,align=center,below=0cm of pix,anchor=center] (caption) {\textsc{With a convex lens}};
...
%end of "I'm Really Having No Difficulty At All Believing It's Not \wrapfig" 
...
<No, no, my dear Watson, not all—by no means all. I would suggest, for example, that a presentation to a doctor is more likely to come from a hospital than from a hunt, and that when the initials <\textsc{c.c.}> are placed before that hospital the words <Charing Cross> very naturally suggest themselves.>

<You may be right.>

<The probability lies in that direction. And if we take this as a working hypothesis we have a fresh basis from which to start our construction of this unknown visitor.>

<Well, then, supposing that <\textsc{c.c.h.}> does stand for <Charing Cross Hospital>, what further inferences may we draw?>
...
\begin{withfootnotes}
<Mister, sir, Mister—a humble \textsc{m.r.c.s.}\footnote{Member of the Royal College of Surgeons, who in the UK traditionally do not use the title <Doctor>.}>
\end{withfootnotes}

\begin{withoutfootnotes}
<Mister, sir, Mister—a humble \textsc{m.r.c.s.}>
