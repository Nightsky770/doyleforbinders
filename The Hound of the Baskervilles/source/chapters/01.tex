...
\node[anchor=center] (pix) at ($(current page.west)+(4cm,0cm)$) {\includegraphics[width=.5\textwidth]{01_convexlens}};
...
\node[anchor=center] (pix) at ($(current page.west)+(4.2cm,0.5cm)$) {\includegraphics[width=.5\textwidth]{01_convexlens}};
