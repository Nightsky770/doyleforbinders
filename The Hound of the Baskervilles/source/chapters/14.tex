...
\begin{letter}
	\begin{figure}[tbh]
		\centering
		\includegraphics[width=0.7\linewidth]{14_uncurtained}
		\caption{Through the uncurtained window}
	\end{figure}
\end{letter}
\begin{a4}
	\begin{figure}[tbh]
		\centering
		\includegraphics[width=0.6\linewidth]{14_uncurtained}
		\caption{Through the uncurtained window}
	\end{figure}
\end{a4}
...
\begin{figure}[tbph]
\centering
\includegraphics[width=\linewidth]{14_boot}
\caption{He held an old black boot}
\end{figure}
