...
\begin{letter}
	\begin{figure}[tbh]
		\centering
		\includegraphics[width=.8\textwidth]{11_goodday}
...
\begin{a4}
	\begin{figure}[tbh]
		\centering
		\includegraphics[width=.7\textwidth]{11_goodday}
		\caption{<Good-day, Dr~Watson,> cried he}
	\end{figure}
\end{a4}
...
\begin{letter}
	\begin{figure}[tbh]
		\centering
		\includegraphics[width=.8\linewidth]{11_frankscope}
