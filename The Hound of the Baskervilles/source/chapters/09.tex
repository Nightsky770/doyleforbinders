...
\lettrine{S}{econd} report of Dr~Watson. \\
\begin{flushright}
...
\begin{a4}
	\begin{figure}[tb]
		\centering
		\includegraphics[width=.8\linewidth]{09_shoulder}
...
\begin{letter}
	\begin{figure}[tb]
		\centering
		\includegraphics[width=.9\linewidth]{09_shoulder}
		\caption{Sir~Henry put his hand upon my shoulder}
	\end{figure}
\end{letter}
...
\begin{letter}
	\begin{figure}[tbh]
		\centering
		\includegraphics[width=.75\linewidth]{09_doinghere}
...
\begin{a4}
	\begin{figure}[tbh]
		\centering
		\includegraphics[width=.6\linewidth]{09_doinghere}
		\caption{<What are you doing here, Barrymore?>}
	\end{figure}
\end{a4}
...
\begin{a4}
	\begin{figure}[tbh]
		\centering
		\includegraphics[width=.9\linewidth]{09_escaped}
		\caption{<The escaped convict, sir—Selden, the criminal.>}
	\end{figure}
\end{a4}
