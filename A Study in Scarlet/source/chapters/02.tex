...
\begin{center}
	{\Large\textsc{Sherlock Holmes}---his limits.}
\vspace{0.5em}

%	\begin{center}\textsc{sherlock holmes}---his limits.\end{center}
\begin{tabularx}{\linewidth}{l X c X c p{0.35\linewidth}}
