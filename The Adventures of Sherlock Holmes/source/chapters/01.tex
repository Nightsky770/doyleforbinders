...
\begin{figure}[tbh]
\centering
\includegraphics[width=\linewidth]{01_mask}
\caption{<I have come \textit{incognito} from Prague for the purpose of consulting you.>}
\end{figure}
...
<Quite so; but the sequel was rather unusual. I will tell you, however. I left the house a little after eight o'clock this morning in the character of a groom out of work. There is a wonderful sympathy and freemasonry among horsey men. Be one of them, and you will know all that there is to know. I soon found Briony Lodge. It is a \textit{bijou} villa, with a garden at the back, but built out in front right up to the road, two stories. Chubb lock to the door. Large sitting-room on the right side, well furnished, with long windows almost to the floor, and those preposterous English window fasteners which a child could open. Behind there was nothing remarkable, save that the passage window could be reached from the top of the coach-house. I walked round it and examined it closely from every point of view, but without noting anything else of interest.

\begin{figure}[p]
\centering
\includegraphics[width=\linewidth]{01_ostlers}
\caption{<I lent the ostlers a hand>}
\end{figure}
...
\begin{figure}[tbph]
\centering
\includegraphics[width=\linewidth]{01_landau}
\caption{Up the lane came a neat little landau}
\end{figure}
...
\begin{figure}[tbph]
\centering
\includegraphics[width=\linewidth]{01_fight}
\caption{He gave a cry and dropped to the ground}
\end{figure}
...
\begin{figure}[tbph]
\centering
\includegraphics[width=\linewidth]{01_hiding}
\caption{A recess behind a sliding panel just above the right bell-pull}
\end{figure}
...
\lettrine[lines=4]{I}{} slept at Baker Street that night, and we were engaged upon our toast and coffee in the morning when the King of Bohemia rushed into the room.
...
\begin{mail}{}{My dear Mr~Sherlock Holmes,}
...
\closeletter[Very truly yours,]{Irene Norton, \textit{née} Adler.}
\end{mail}
...
<I am immensely indebted to you. Pray tell me in what way I can reward you. This ring\longdash> He slipped an emerald snake ring from his finger and held it out upon the palm of his hand.
...
And that was how a great scandal threatened to affect the kingdom of Bohemia, and how the best plans of Mr~Sherlock Holmes were beaten by a woman's wit. He used to make merry over the cleverness of women, but I have not heard him do it of late. And when he speaks of Irene Adler, or when he refers to her photograph, it is always under the honourable title of \textit{the} woman.

		\begin{figure}[b!]
\centering
\includegraphics[width=.5\linewidth]{01_tailpiece}
