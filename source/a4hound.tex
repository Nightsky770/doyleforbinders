\documentclass[paper=a5,BCOR=7mm,twoside,DIV=calc,12pt,usegeometry,openany,chapterprefix,endperiod]{scrbook} % Document font size and paper size
...
\begin{figure}[tbhp]
\centering
\includegraphics[width=.9\textwidth]{06_driverwhip}
