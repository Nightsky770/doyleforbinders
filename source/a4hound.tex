\documentclass[paper=a5,BCOR=10mm,twoside,DIV=15,12pt,usegeometry,openany]{scrbook} % Document font size and paper size
...
\begin{figure}[p]
\centering
\includegraphics[width=\linewidth]{craggy}
...
\blockquote{\textsc{Wire received. Coming down with unsigned warrant. Arrive five-forty.\textemdash \begin{small}LESTRADE\end{small}.}}
