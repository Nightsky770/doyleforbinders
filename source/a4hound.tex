...
%\newfontfamily\mytitlefont{WitchkinFree-axXAE.ttf}
...
{\HUGE Baskervilles}\\
\vspace*{.5cm}
 \includegraphics[width=.75\linewidth]{houndfront}
 \end{center}
 \vspace*{.1cm}
...
\begin{flushright}
\textemdash {\small\scshape BASKERVILLE.}
\end{flushright} 
}
\end{samepage}
...
\begin{flushright}
\textemdash {\small\scshape CARTWRIGHT.}
\end{flushright}
}
\end{samepage}
...
\begin{wrapfigure}[18]{O}{0.7\textwidth}
\centering
...
\begin{flushright}
\textemdash  {\small\scshape LESTRADE.}
\end{flushright}
}
\end{samepage}
